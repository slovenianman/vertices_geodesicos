...
var style_Vrticesgeodsicos_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("elevación_sobre_el_nivel_del_mar");
    var labelText = "";
    size = 0;
    ...
    if (value >= 0.000000 && value <= 1000.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3000.000000 && value <= 3707.384000) {
            style = [ new ol.style.Style({
